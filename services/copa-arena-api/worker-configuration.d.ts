/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: c04d704243fa623710c8f3f89d707b51)
// Runtime types generated with workerd@1.20260730.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ARENA_ANALYTICS: AnalyticsEngineDataset;
	ARENA_LIMITER: RateLimit;
	ARENA_SESSION_LIMITER: RateLimit;
	ALLOWED_ORIGINS: "https://copa.life,https://www.copa.life,https://localhost,http://localhost,capacitor://localhost";
	GOOGLE_CLIENT_IDS: "910942499457-79rqm001821h0tealgup26jba3jrnkmc.apps.googleusercontent.com,910942499457-he22hdttfr6pnkf4jsentluc7l3flr6a.apps.googleusercontent.com,910942499457-puuqtrlff1itdu0cejbg990cf1lt4e4a.apps.googleusercontent.com";
	ARENA_MATCHMAKER: DurableObjectNamespace<import("./src/index").ArenaMatchmaker>;
	ARENA_ROOM: DurableObjectNamespace<import("./src/index").ArenaRoom>;
	ARENA_TOURNAMENT: DurableObjectNamespace<import("./src/index").ArenaTournament>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ArenaMatchmaker" | "ArenaRoom" | "ArenaTournament";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "GOOGLE_CLIENT_IDS">> {}
}
