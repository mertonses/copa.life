...
CREATE INDEX IF NOT EXISTS notification_token_platform_lookup ON notification_tokens(platform, active, last_seen_at);
CREATE INDEX IF NOT EXISTS notification_token_client_lookup ON notification_tokens(client_hash, active);
