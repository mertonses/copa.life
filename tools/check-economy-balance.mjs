...
expect(/COMMON toplam final cezasının %50'sini telafi eder/.test(files.html)&&/DARK offsets 75%/.test(files.html),"fallback Crisis Management copy is stale");
...
expect(/const rate=v===1\?0\.75:0\.50/.test(files.effects)&&/Math\.ceil\(finalPenalty\*rate\)/.test(files.effects),"Crisis Management does not enforce the 50% / 75% rule");
