...
if (report.home[8].stats.goals !== 1 || report.away[9].stats.goals !== 1 || report.home[3].stats.yellow !== 1) throw new Error("Gerçek event verisi oyunculara bağlanmadı");
...
for (const marker of [".last-match-report", ".lmr-pitch", ".lmr-player", 'html[data-theme="dark"]', "@media(max-width:760px)"]) {
