...
const budgets = [
  ...
  // The shared five-language runtime, compact setup surface and native
  // interaction styles currently measure 687KB gzip on the release artifact.
  // Keep a 13KB guard above that verified baseline so the cross-platform
  // release gate still catches meaningful first-load growth.
  ["critical html/js/css gzip", criticalGzip, 700 * 1024],
