...
const budgets = [
  ...
  // Arena live intelligence, training, finance and relationship UI form the
  // validated first-party runtime baseline; heavy reports and simulation stay lazy.
  ["critical html/js/css gzip", criticalGzip, 602 * 1024],
