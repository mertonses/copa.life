...
async function reachHub(page:any){
  ...
  await page.evaluate(()=>{const game=globalThis as any;game.pcGo();game.fastTournamentDraw();game.finishTournamentDraw();game.setCaptain(0);game.pendingChairmanEvent=null;game.CopaClubFiles.select("debt");game.closeModal();game.CopaMobileShell.enhanceHub();});
