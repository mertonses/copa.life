...
const brand=`<div class="brand"><span>Copa</span><b>Life</b><em>× ARENA</em></div>`;
function html(width,height,kind,locale="tr-TR"){
  ...
  const scenes=portrait?(english?[
    ...
    {start:12.6,end:15,cls:"outro",copy:`${brand}<h2>BUILD.<br>PLAY.<br><b>RISE.</b></h2><div class="cta">START NOW</div>`},
  ]:[
    ...
    {start:12.6,end:15,cls:"outro",copy:`${brand}<h2>KUR.<br>OYNA.<br><b>YÜKSEL.</b></h2><div class="cta">ŞİMDİ BAŞLA</div>`},
  ]):(english?[
    ...
    {start:17.6,end:24,cls:"outro",copy:`${brand}<h2>STEP ONTO THE PITCH.<br><b>WRITE YOUR STORY.</b></h2><p>Build in Life. Challenge in Arena.</p><div class="cta">START NOW</div>`},
  ]:[
    ...
    {start:17.6,end:24,cls:"outro",copy:`${brand}<h2>SAHAYA ÇIK.<br><b>HİKÂYENİ YAZ.</b></h2><p>Life'ta kur. Arena'da meydan oku.</p><div class="cta">ŞİMDİ BAŞLA</div>`},
  ]);
...
try{
  await render(browser,{kind:"store",width:1920,height:1080,duration:24,file:"copa-life-store-trailer-rhythm-silent-tr-TR.mp4"});
  await render(browser,{kind:"reels",width:1080,height:1920,duration:15,file:"copa-life-reels-rhythm-silent-tr-TR.mp4"});
  await render(browser,{kind:"store",width:1920,height:1080,duration:24,locale:"en-US",file:"copa-life-store-trailer-rhythm-silent-en-US.mp4"});
  await render(browser,{kind:"reels",width:1080,height:1920,duration:15,locale:"en-US",file:"copa-life-reels-rhythm-silent-en-US.mp4"});
