...
Son teknik kontrol: 21 Temmuz 2026. Bu dosya, Console açıldığında cevapların doğrudan girilebilmesi için hazırlanmıştır. Köşeli parantezli kuruluş alanları D‑U‑N‑S ve yayın iletişim bilgileri kesinleşince doldurulacaktır.
...
| Destek e-postası | `[DOĞRULANMIŞ DESTEK E-POSTASI — Gmail veya özel alan adı]` |
...
- Takedown kanalı: **Evet**, ancak yayımdan önce doğrulanmış ve düzenli izlenen destek e-postasıyla son kontrol yapılacak.
