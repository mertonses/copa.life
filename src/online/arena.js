(function(root){
  ...
  const COPY={
    tr:{
      ...
      selected:"SEÇİLDİ",startingXI:"İLK 11",babacan:"BABACAN BAŞKAN",practice:"ANTRENMAN MAÇI",practiceCopy:"Ödülsüz, derecesiz bir prova maçı. Taktiklerini burada deneyebilirsin.",practiceAgain:"YENİ PROVA",networkGood:"İYİ",networkFair:"ORTA",networkPoor:"ZAYIF",
      googleTitle:"ARENA HESABIN",googleCopy:"Dereceni ve maç geçmişini tüm cihazlarında koru.",googleContinue:"GOOGLE İLE DEVAM ET",googleReady:"GOOGLE HESABI BAĞLANDI",googleConfig:"Google girişi henüz yapılandırılmadı.",googleFailed:"Google ile giriş tamamlanamadı. Tekrar deneyebilirsin.",googleCancelled:"Google ile giriş iptal edildi.",
    ...
    en:{
      ...
      selected:"SELECTED",startingXI:"STARTING XI",babacan:"BABACAN CHAIRMAN",practice:"PRACTICE MATCH",practiceCopy:"A rewardless, unranked match for trying out your tactics.",practiceAgain:"NEW PRACTICE MATCH",networkGood:"GOOD",networkFair:"FAIR",networkPoor:"POOR",
      googleTitle:"YOUR ARENA ACCOUNT",googleCopy:"Keep your rating and match history on every device.",googleContinue:"CONTINUE WITH GOOGLE",googleReady:"GOOGLE ACCOUNT CONNECTED",googleConfig:"Google sign-in is not configured yet.",googleFailed:"Google sign-in could not be completed. Please try again.",googleCancelled:"Google sign-in was cancelled.",
  ...
  Object.assign(COPY.es,{multiplayer:"MULTIJUGADOR",queueCopy:"Buscando un club adecuado de nivel similar.",authentic:"EMPAREJAMIENTO RÁPIDO",noBots:"Encuentra un rival de nivel similar en segundos.",fair:"MISMAS CONDICIONES",fairCopy:"Ambos clubes compiten con el mismo tiempo y oportunidades.",server:"RESULTADO VERIFICADO",serverCopy:"El marcador y las decisiones se verifican de forma segura.",forfeitWin:"VICTORIA POR ABANDONO",forfeitLoss:"DERROTA POR ABANDONO",voided:"PARTIDO ANULADO",voidedCopy:"Ningún equipo tomó suficientes decisiones. La puntuación y el progreso de temporada no cambiaron.",rematch:"PEDIR REVANCHA",rematchSent:"SOLICITUD DE REVANCHA ENVIADA",rematchIncoming:"EL RIVAL QUIERE LA REVANCHA",rematchStarting:"COMIENZA LA REVANCHA",leave:"ABANDONAR",leaveTitle:"ABANDONAR PARTIDO",leaveCopy:"El partido terminará de inmediato con una derrota por 0–3.",leaveCheck:"Acepto la derrota por 0–3.",leaveConfirm:"ABANDONAR Y TERMINAR",leaveCancel:"CANCELAR",inactivityOne:"Se tomó una decisión automática. Tres omisiones seguidas causan derrota.",inactivityTwo:"ÚLTIMO AVISO: Otra omisión causará una derrota por 0–3.",practice:"PARTIDO DE PRÁCTICA",practiceCopy:"Un partido sin premios ni clasificación para probar tus tácticas.",practiceAgain:"NUEVO PARTIDO DE PRÁCTICA"});
  Object.assign(COPY.de,{multiplayer:"MEHRSPIELER",queueCopy:"Ein passender Club mit ähnlicher Wertung wird gesucht.",authentic:"SCHNELLE SUCHE",noBots:"Finde in Sekunden einen passenden Gegner.",fair:"GLEICHE BEDINGUNGEN",fairCopy:"Beide Clubs spielen mit derselben Zeit und denselben Chancen.",server:"GEPRÜFTES ERGEBNIS",serverCopy:"Spielstand und Entscheidungen werden sicher geprüft.",forfeitWin:"SIEG DURCH AUFGABE",forfeitLoss:"NIEDERLAGE DURCH AUFGABE",voided:"MATCH ANNULLIERT",voidedCopy:"Keine Seite traf genug Entscheidungen. Wertung und Saisonfortschritt blieben unverändert.",rematch:"REVANCHE ANFRAGEN",rematchSent:"REVANCHE ANGEFRAGT",rematchIncoming:"GEGNER WILL EINE REVANCHE",rematchStarting:"REVANCHE STARTET",leave:"AUFGEBEN",leaveTitle:"MATCH AUFGEBEN",leaveCopy:"Das Match endet sofort mit einer 0–3-Niederlage.",leaveCheck:"Ich akzeptiere die 0–3-Niederlage.",leaveConfirm:"AUFGEBEN UND BEENDEN",leaveCancel:"ABBRECHEN",inactivityOne:"Eine Entscheidung wurde automatisch getroffen. Drei Versäumnisse in Folge führen zur Niederlage.",inactivityTwo:"LETZTE WARNUNG: Noch ein Versäumnis führt zu einer 0–3-Niederlage.",practice:"TRAININGSSPIEL",practiceCopy:"Ein Spiel ohne Belohnung und Wertung, um deine Taktik zu testen.",practiceAgain:"NEUES TRAININGSSPIEL"});
  Object.assign(COPY.it,{multiplayer:"MULTIGIOCATORE",queueCopy:"Cerchiamo un club adatto di livello simile.",authentic:"RICERCA RAPIDA",noBots:"Trova in pochi secondi un avversario adatto.",fair:"STESSE CONDIZIONI",fairCopy:"Entrambi i club giocano con lo stesso tempo e le stesse opportunità.",server:"RISULTATO VERIFICATO",serverCopy:"Punteggio e decisioni vengono verificati in sicurezza.",forfeitWin:"VITTORIA A TAVOLINO",forfeitLoss:"SCONFITTA A TAVOLINO",voided:"PARTITA ANNULLATA",voidedCopy:"Nessuna squadra ha preso abbastanza decisioni. Punteggio e progresso stagionale non sono cambiati.",rematch:"CHIEDI RIVINCITA",rematchSent:"RICHIESTA DI RIVINCITA INVIATA",rematchIncoming:"L'AVVERSARIO VUOLE UNA RIVINCITA",rematchStarting:"INIZIA LA RIVINCITA",leave:"ABBANDONA",leaveTitle:"ABBANDONA PARTITA",leaveCopy:"La partita termina subito con una sconfitta per 0–3.",leaveCheck:"Accetto la sconfitta per 0–3.",leaveConfirm:"ABBANDONA E TERMINA",leaveCancel:"ANNULLA",inactivityOne:"Una scelta è stata automatica. Tre assenze consecutive causano la sconfitta.",inactivityTwo:"ULTIMO AVVISO: Un'altra assenza causerà una sconfitta per 0–3.",practice:"PARTITA DI PROVA",practiceCopy:"Una partita senza premi né classifica per provare le tue tattiche.",practiceAgain:"NUOVA PARTITA DI PROVA"});
  Object.assign(COPY.tr,{systemManaged:"HAZIR KULÜP"});
  Object.assign(COPY.en,{systemManaged:"READY-MADE CLUB"});
  Object.assign(COPY.es,{systemManaged:"CLUB PREPARADO",candidate:"ASPIRANTE",bronze:"BRONCE",silver:"PLATA",gold:"ORO",diamond:"DIAMANTE",legend:"LEYENDA",selected:"ELEGIDO",startingXI:"ONCE INICIAL",babacan:"PRESIDENTE BABACAN",practice:"PARTIDO DE PRÁCTICA",practiceCopy:"Un partido sin premios ni clasificación para probar tus tácticas.",practiceAgain:"NUEVO PARTIDO DE PRÁCTICA",networkGood:"BUENA",networkFair:"MEDIA",networkPoor:"DÉBIL",googleTitle:"TU CUENTA ARENA",googleCopy:"Conserva tu puntuación y tu historial en todos tus dispositivos.",googleContinue:"CONTINUAR CON GOOGLE",googleReady:"CUENTA DE GOOGLE VINCULADA",googleConfig:"El acceso con Google aún no está configurado.",or:"O",guestContinue:"CONTINUAR COMO INVITADO",guestFast:"ENTRAR SIN REGISTRARSE",guestNote:"El progreso de invitado solo se guarda en este dispositivo.",guestName:"Invitado"});
  Object.assign(COPY.de,{systemManaged:"BEREITER CLUB",candidate:"ANWÄRTER",bronze:"BRONZE",silver:"SILBER",gold:"GOLD",diamond:"DIAMANT",legend:"LEGENDE",selected:"GEWÄHLT",startingXI:"STARTELF",babacan:"PRÄSIDENT BABACAN",practice:"TRAININGSSPIEL",practiceCopy:"Ein Spiel ohne Belohnung und Wertung, um deine Taktik zu testen.",practiceAgain:"NEUES TRAININGSSPIEL",networkGood:"GUT",networkFair:"MITTEL",networkPoor:"SCHWACH",googleTitle:"DEIN ARENA-KONTO",googleCopy:"Sichere Wertung und Verlauf auf allen Geräten.",googleContinue:"MIT GOOGLE FORTFAHREN",googleReady:"GOOGLE-KONTO VERKNÜPFT",googleConfig:"Google-Anmeldung ist noch nicht eingerichtet.",or:"ODER",guestContinue:"ALS GAST FORTFAHREN",guestFast:"OHNE REGISTRIERUNG STARTEN",guestNote:"Gastfortschritt bleibt nur auf diesem Gerät.",guestName:"Gast"});
  Object.assign(COPY.it,{systemManaged:"CLUB PRONTO",candidate:"ASPIRANTE",bronze:"BRONZO",silver:"ARGENTO",gold:"ORO",diamond:"DIAMANTE",legend:"LEGGENDA",selected:"SCELTO",startingXI:"UNDICI TITOLARE",babacan:"PRESIDENTE BABACAN",practice:"PARTITA DI PROVA",practiceCopy:"Una partita senza premi né classifica per provare le tue tattiche.",practiceAgain:"NUOVA PARTITA DI PROVA",networkGood:"BUONA",networkFair:"MEDIA",networkPoor:"DEBOLE",googleTitle:"IL TUO ACCOUNT ARENA",googleCopy:"Conserva punteggio e cronologia su tutti i dispositivi.",googleContinue:"CONTINUA CON GOOGLE",googleReady:"ACCOUNT GOOGLE COLLEGATO",googleConfig:"L'accesso Google non è ancora configurato.",or:"OPPURE",guestContinue:"CONTINUA COME OSPITE",guestFast:"ENTRA SENZA REGISTRARTI",guestNote:"I progressi ospite restano solo su questo dispositivo.",guestName:"Ospite"});
  Object.assign(COPY.es,{googleFailed:"No se pudo completar el acceso con Google. Inténtalo de nuevo.",googleCancelled:"Se canceló el acceso con Google."});
  Object.assign(COPY.de,{googleFailed:"Die Google-Anmeldung konnte nicht abgeschlossen werden. Versuche es erneut.",googleCancelled:"Die Google-Anmeldung wurde abgebrochen."});
  Object.assign(COPY.it,{googleFailed:"Non è stato possibile completare l'accesso con Google. Riprova.",googleCancelled:"L'accesso con Google è stato annullato."});
  const state={screen:"closed",profile:null,history:[],leaderboard:[],socket:null,room:null,googleUser:null,googleLoading:false,setupDraft:null,setupSubmitting:false,planDraft:null,planSubmitting:false,emoteMenu:false,emoteReadyAt:0,emoteCooldownTimer:null,emoteHideTimer:null,forfeitConfirm:false,liveEventCues:new Set(),queueStarted:0,timer:null,heartbeat:null,deadlineTimer:null,retryTimer:null,retries:0,reconnectAt:0,connection:"idle",latency:null,pingAt:0,lastNetworkBand:"",lastNetworkTelemetry:0,lastError:"",lastResultSound:"",lastPenaltySound:"",lastAudioCue:"",audioCueCount:0,audioClockTimer:null,audioClockBeat:0,audioClockActive:false,searchAudio:null,searchFadeTimer:null,lastArenaAdMatchId:"",systemOpponentTracked:"",customRoom:null,customInput:"",customBusy:false,customPoll:null,customPollInFlight:false,customPollGeneration:0,tournament:null,tournamentInput:"",tournamentBusy:false,tournamentPoll:null,tournamentPollInFlight:false,tournamentPollGeneration:0,roomConnectionKey:"",roomConnectGeneration:0,cosmeticCatalog:REWARDS};
  ...
  const googleErrorMessage=error=>{
    const code=String(error&&error.message||error||"").toLowerCase();
    return code.includes("cancel")||code.includes("abort")?text("googleCancelled"):text("googleFailed");
  };
  ...
  async function finishGoogleSignIn(credential){
    ...
    try{
      ...
      set(TOKEN_KEY,data.token);set(GOOGLE_USER_KEY,JSON.stringify(data.user||{}));state.googleUser=data.user||{};state.googleLoading=false;state.lastError="";render();
    }catch(error){state.googleLoading=false;state.lastError=googleErrorMessage(error);render();}
  }
  async function nativeGoogleSignIn(){
    ...
    try{
      ...
      const login=await plugin.login({provider:"google",options:{filterByAuthorizedAccounts:false,autoSelectEnabled:false}});
  ...
  function terms(){
    ...
    return chrome(`<article class="arena-consent"><div class="arena-crest">${icon("arena")}</div><span class="arena-kicker">${esc(text("ranked"))}</span><h1>${esc(text("consentTitle"))}</h1><p>${esc(text("consent"))}</p><section class="arena-google-auth ${user?"is-ready":""}"><span>${esc(text("googleTitle"))}</span><p>${esc(text("googleCopy"))}</p>${user?`<div class="arena-google-user"><i>${user.guest?"◇":"G"}</i><span><b>${esc(user.name||text("googleReady"))}</b><small>${esc(user.guest?text("guestNote"):user.email||text("googleReady"))}</small></span><em>✓</em></div>`:nativePlatform()?`<button type="button" class="arena-google-button" data-arena-action="google">${state.googleLoading?"…":`<i>G</i>${esc(text("googleContinue"))}`}</button>`:`<div class="arena-google-slot" data-google-slot></div>`}${user?"":`<div class="arena-auth-divider"><span>${esc(text("or"))}</span></div><button type="button" class="arena-guest-button" data-arena-action="guest"><i>◇</i><span><b>${esc(text("guestContinue"))}</b><small>${esc(text("guestFast"))}</small></span><em>→</em></button><small class="arena-guest-note">${esc(text("guestNote"))}</small>`}${state.lastError?`<small class="arena-google-error" role="alert">${esc(state.lastError)}</small>`:""}</section>${user?`<label><span>${esc(text("club"))}</span><input data-arena-club maxlength="29" value="${esc(clubName())}" autocomplete="off"></label><div class="arena-trust-row"><span>${icon("shield")}<b>${esc(text("authentic"))}</b><small>${esc(text("noBots"))}</small></span><span>${icon("rank")}<b>${esc(text("fair"))}</b><small>${esc(text("fairCopy"))}</small></span></div><button class="arena-primary" data-arena-action="accept">${esc(text("accept"))}</button>`:""}</article>`);
  }
  ...
  function statusStrip(game){
    ...
    const systemBadge=opponent.systemManaged?`<em class="arena-system-club">${esc(text("systemManaged"))}</em>`:"";
    return `<div class="arena-versus"><span class="is-self"><small>${esc(text("you"))}</small><div class="arena-club-line"><b>${esc(self.clubName||"—")}</b>${trigger}${emoteReaction(emotes.self,"self")}</div><strong>${self.rating||"—"}</strong>${enabled&&state.emoteMenu?emotePicker():""}</span><i>VS</i><span class="is-opponent"><small>${esc(text("opponent"))}${systemBadge}</small><div class="arena-club-line"><b>${esc(opponent.clubName||"—")}</b>${emoteReaction(emotes.opponent,"opponent")}</div><strong>${opponent.rating||"—"}</strong></span></div><div class="arena-phase-status ${opponent.connected?"is-connected":"is-reconnecting"}"><span>${esc(presence)}</span><b data-arena-deadline="${Number(game.deadline)||0}" data-arena-deadline-label="${esc(phaseLabel)}"></b>${leave}</div>${grace}${warning}`;
  }
  ...
  function lobby(game){
    const self=game.self||{},opponent=game.opponent||{},mine=game.team||{},theirs=game.opponentTeam||{};
    const ready=!!self.ready,opponentReady=!!opponent.ready;
    const stateLabel=ready?(opponentReady?local("MAÇ BAŞLATILIYOR","STARTING MATCH"):local("RAKİP HAZIRLIĞI BEKLENİYOR","WAITING FOR OPPONENT")):local("KADRONU ONAYLA","CONFIRM YOUR SQUAD");
    const clubCard=(side,club,team,isReady)=>`<article class="is-${side} ${isReady?"is-ready":""}"><small>${esc(side==="self"?text("you"):text("opponent"))}</small><strong>${esc(club.clubName||"—")}</strong><div><span><b>${esc(text("power"))}</b><em class="power-${powerBand(team.power)}">${team.power||"—"}</em></span><span><b>${esc(text("chemistry"))}</b><em>${team.chemistry==null?"—":team.chemistry}</em></span></div><i>${isReady?"✓":local("BEKLİYOR","WAITING")}</i></article>`;
    return chrome(`${statusStrip(game)}<div class="arena-ready"><section class="arena-faceoff" aria-label="${esc(local("Karşılaşma kartı","Match faceoff"))}">${clubCard("self",self,mine,ready)}<b>VS</b>${clubCard("opponent",opponent,theirs,opponentReady)}</section><div class="arena-ready-status"><div class="arena-ready-ring">${icon("shield")}<i></i></div><span>${esc(stateLabel)}</span><h1>${esc(ready?text("waiting"):text("ready"))}</h1><p>${esc(text("serverCopy"))}</p></div><button class="arena-primary" data-arena-action="ready" ${ready?"disabled":""}>${esc(text("ready"))}</button></div>`);
  }
  ...
  function resultMvp(game){
    const sides=[game.self||{},game.opponent||{}];let best=null;
    sides.forEach((side,sideIndex)=>(side.draft||[]).forEach(player=>{
      const power=Number(player.effectivePower??player.power??player.ov)||0;
      const candidate={name:player.name||local("İsimsiz oyuncu","Unnamed player"),position:player.position||player.pos||player.slot||"—",power,sideIndex};
      if(!best||candidate.power>best.power)best=candidate;
    }));
    return best;
  }
  function resultFactors(game,myTeam,theirTeam){
    const history=liveHistory(game),selfHome=game.selfIndex===0;
    const xg=history.reduce((sum,item)=>[sum[0]+Number((selfHome?item.homeXg:item.awayXg)||0),sum[1]+Number((selfHome?item.awayXg:item.homeXg)||0)],[0,0]);
    const powerDelta=Number(myTeam.power||0)-Number(theirTeam.power||0),chemDelta=Number(myTeam.chemistry||0)-Number(theirTeam.chemistry||0),xgDelta=xg[0]-xg[1];
    const tone=value=>value>.08?"is-positive":value<-.08?"is-negative":"is-neutral";
    return [
      {label:local("KADRO KALİTESİ","SQUAD QUALITY"),value:`${myTeam.power||"—"}–${theirTeam.power||"—"}`,tone:tone(powerDelta),copy:powerDelta>2?local("Bireysel kalite sende üstünlük kurdu.","Individual quality gave you the edge."):powerDelta<-2?local("Rakibin bireysel kalitesi daha yüksekti.","The opponent had more individual quality."):local("Kadrolar birbirine yakın güçteydi.","The squads were closely matched.")},
      {label:local("TAKIM UYUMU","TEAM COHESION"),value:`${myTeam.chemistry??"—"}–${theirTeam.chemistry??"—"}`,tone:tone(chemDelta),copy:chemDelta>1?local("Takım uyumun kararları hızlandırdı.","Your cohesion sharpened the decisions."):chemDelta<-1?local("Rakip daha uyumlu bir oyun kurdu.","The opponent played with more cohesion."):local("Takım uyumu maçı tek başına belirlemedi.","Cohesion did not decide the match alone.")},
  ...
  function penalty(game){
    ...
    const suddenDeath=!!shootout.suddenDeath||(Number(shootout.kicks&&shootout.kicks[0])>=5&&Number(shootout.kicks&&shootout.kicks[1])>=5&&mine===theirs);
    return chrome(`${statusStrip(game)}<section class="arena-penalty ${reveal?"is-reveal":""} ${suddenDeath?"is-sudden-death":""}">
  ...
  function result(game){
    ...
    const practice=game.mode==="practice",tournament=game.mode==="tournament",rematch=game.rematch||{},mvp=resultMvp(game),factors=resultFactors(game,myTeam,theirTeam);
  ...
  function stopCustomPolling(){clearInterval(state.customPoll);state.customPoll=null;state.customPollGeneration++;}
  ...
  async function pollCustomRoom(generation=state.customPollGeneration){
    ...
    }finally{state.customPollInFlight=false;}
  }
  function startCustomPolling(){if(state.customPoll)return;stopCustomPolling();const generation=state.customPollGeneration;pollCustomRoom(generation);state.customPoll=setInterval(()=>pollCustomRoom(generation),1500);}
  ...
  function stopTournamentPolling(){clearInterval(state.tournamentPoll);state.tournamentPoll=null;state.tournamentPollGeneration++;}
  ...
  async function pollTournament(generation=state.tournamentPollGeneration){
    ...
    try{
      ...
      if(state.screen==="tournament")render();
    }finally{state.tournamentPollInFlight=false;}
  }
  function startTournamentPolling(){if(state.tournamentPoll)return;stopTournamentPolling();const generation=state.tournamentPollGeneration;pollTournament(generation);state.tournamentPoll=setInterval(()=>pollTournament(generation),1500);}
  ...
  function connectRoom(saved){
    ...
    socket.addEventListener("message",event=>{
      ...
      if(data.type==="state"){
        ...
        state.room=data.state;state.screen="room";
        if(data.state.opponent&&data.state.opponent.systemManaged&&state.systemOpponentTracked!==data.state.matchId){state.systemOpponentTracked=data.state.matchId;telemetry("arena_system_opponent_shown","ranked");}
        render();
