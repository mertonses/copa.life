(function(root){
  ...
  Object.assign(COPY.tr,{systemManaged:"SİSTEM KULÜBÜ"});
  Object.assign(COPY.en,{systemManaged:"SYSTEM CLUB"});
  Object.assign(COPY.es,{systemManaged:"CLUB DEL SISTEMA",candidate:"ASPIRANTE",bronze:"BRONCE",silver:"PLATA",gold:"ORO",diamond:"DIAMANTE",legend:"LEYENDA",selected:"ELEGIDO",startingXI:"ONCE INICIAL",babacan:"PRESIDENTE BABACAN",practice:"ENTRENAMIENTO IA",practiceCopy:"Ensayo sin premios ni clasificación, controlado por el servidor.",practiceAgain:"NUEVO ENTRENAMIENTO",networkGood:"BUENA",networkFair:"MEDIA",networkPoor:"DÉBIL",googleTitle:"TU CUENTA ARENA",googleCopy:"Conserva tu puntuación y tu historial en todos tus dispositivos.",googleContinue:"CONTINUAR CON GOOGLE",googleReady:"CUENTA DE GOOGLE VINCULADA",googleConfig:"El acceso con Google aún no está configurado.",or:"O",guestContinue:"CONTINUAR COMO INVITADO",guestFast:"ENTRAR SIN REGISTRARSE",guestNote:"El progreso de invitado solo se guarda en este dispositivo.",guestName:"Invitado"});
  Object.assign(COPY.de,{systemManaged:"SYSTEMCLUB",candidate:"ANWÄRTER",bronze:"BRONZE",silver:"SILBER",gold:"GOLD",diamond:"DIAMANT",legend:"LEGENDE",selected:"GEWÄHLT",startingXI:"STARTELF",babacan:"PRÄSIDENT BABACAN",practice:"KI-TRAINING",practiceCopy:"Belohnungsfreies, ungewertetes und servergesteuertes Testspiel.",practiceAgain:"NEUES TRAINING",networkGood:"GUT",networkFair:"MITTEL",networkPoor:"SCHWACH",googleTitle:"DEIN ARENA-KONTO",googleCopy:"Sichere Wertung und Verlauf auf allen Geräten.",googleContinue:"MIT GOOGLE FORTFAHREN",googleReady:"GOOGLE-KONTO VERKNÜPFT",googleConfig:"Google-Anmeldung ist noch nicht eingerichtet.",or:"ODER",guestContinue:"ALS GAST FORTFAHREN",guestFast:"OHNE REGISTRIERUNG STARTEN",guestNote:"Gastfortschritt bleibt nur auf diesem Gerät.",guestName:"Gast"});
  Object.assign(COPY.it,{systemManaged:"CLUB DI SISTEMA",candidate:"ASPIRANTE",bronze:"BRONZO",silver:"ARGENTO",gold:"ORO",diamond:"DIAMANTE",legend:"LEGGENDA",selected:"SCELTO",startingXI:"UNDICI TITOLARE",babacan:"PRESIDENTE BABACAN",practice:"ALLENAMENTO IA",practiceCopy:"Prova senza premi né classifica, controllata dal server.",practiceAgain:"NUOVO ALLENAMENTO",networkGood:"BUONA",networkFair:"MEDIA",networkPoor:"DEBOLE",googleTitle:"IL TUO ACCOUNT ARENA",googleCopy:"Conserva punteggio e cronologia su tutti i dispositivi.",googleContinue:"CONTINUA CON GOOGLE",googleReady:"ACCOUNT GOOGLE COLLEGATO",googleConfig:"L'accesso Google non è ancora configurato.",or:"OPPURE",guestContinue:"CONTINUA COME OSPITE",guestFast:"ENTRA SENZA REGISTRARTI",guestNote:"I progressi ospite restano solo su questo dispositivo.",guestName:"Ospite"});
