...
var round=1,cards=[],cardInv={},cardTier={},shopOffers=[],bracket=[],fixtures=[],opponent=null,lastResult=null,muted=false,autoPlay=false,kit={bg:"#d6543a",fg:"#fff",sec:"#ffffff"},talkUsed=false,talkMod={all:0,def:0,atk:0},deadlineH=24,oppXI=[],motm=null,runEnded=false;
...
var bench=[],benchUsed=0,tempPrime=0,tempPrimePenalty=0,shortCamp=0,shortCampPenalty=0,installmentTurns=0,quietCamp=0,primFreeze=0,lastCreditActive=0,econStats={earned:0,injuries:0,president:0,finalDebt:0,spent:0,worstDebt:0,bestCard:"",bestCardValue:0,worstPresident:""};
