...
function saveMeta(){try{localStorage.setItem("kupayolu",JSON.stringify({u:unlockedForms,b:metaBest,r:metaRuns,t:darkTheme,uc:unlockedChairs,sc:selectedChairId,eb:eliteBonus}));}catch(e){}}
function loadMeta(){try{const d=JSON.parse(localStorage.getItem("kupayolu"));if(d){if(Array.isArray(d.u)&&d.u.length)unlockedForms=d.u;metaBest=d.b||0;metaRuns=d.r||0;darkTheme=(d.t===undefined?false:!!d.t);if(Array.isArray(d.uc)&&d.uc.length)unlockedChairs=d.uc;if(d.sc&&CHAIR_ORDER.includes(d.sc))selectedChairId=d.sc;eliteBonus=d.eb||false;}}catch(e){}}
