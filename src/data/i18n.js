...
var T={
 tr:{tagline:"",budget:"Kasa",coverTitle:"Copa Life",coverSub:"Türkiye Ulusal Kupası",
  coverBlurb:"11'ini draftla. Üç grup maçında ilk ikiyi hedefle; ardından eleme yolunda kupaya yürü.",
  ...
  pickhdr:"Dizilişini seç",proto:"Copa Life prototip · Türkiye üst ve alt ligleri · 1358 oyuncu",
  formSub:{"4-3-3":"klasik","4-4-2":"abi","4-2-3-1":"modern","3-5-2":"kanat","5-3-2":"kale","3-4-3":"hücum","4-5-1":"otobüs"},
  startBtn:"BAŞLA",cNamePh:"Kulübüne bir isim ver...",
  ...
  rounds:["GRUP · 1. MAÇ","GRUP · 2. MAÇ","GRUP · 3. MAÇ","SON 16","ÇEYREK FİNAL","YARI FİNAL","FİNAL"],rabbr:["G1","G2","G3","S16","ÇF","YF","F"],
 ...
 chLbl:"Görevler",chUnlock:"Kart açıldı:",objHdr:"?? HEDEFLER",feedHdr:"GELİŞMELER",feedEmpty:"henüz gelişme yok...",feedBuy:"alındı",feedUnlock:"açıldı",chairHdr:"BAŞKAN",hiddenName:"Gizli Oyuncu",hiddenMeta:"??? · cevher mi balon mu",cevher:"?? Cevher!",balon:"?? Balon:",reveal:"açıldı:",trait:{hizli:"Hızlı",lider:"Lider",buyukmac:"Büyük Maç",sorunlu:"Sorunlu",temasli:"Temaslı Oyun",wonderkid:"Wonderkid"},panicHead:"PANİK TRANSFER!",panicFeed:"deadline doldu, oyuncu dayatıldı",panicMsg:(n,o,p)=>`Menajer ${p} bulamadı. Kadroya ${o} güç ${n} dayatıldı.`,heads:["Galatasaray yeni stoper arıyor","Başkan bütçeyi sorguluyor","Taraftar forvet istiyor","Osimhen dedikoduları sürüyor","Menajer pazarda kulis yapıyor","Yıldız transfer heyecan yarattı","Rakip kulüpte kriz çıktı","Kart pazarı bu hafta hareketli","Kara borsa söylentileri arttı","Başkan prim bütçesini kapattı","Taraftar deplasman bileti peşinde","Kulüp doktoru yoğun mesai yapıyor","Genç oyuncular scout listesinde","Bir menajer gizli teklif getirdi","Sosyal medyada forma tartışması","Rakip savunmada sakatlık alarmı","Kupada sürpriz sonuçlar geceye damga vurdu","Bir yıldız maaşını indirmeye razı","Altyapıdan yeni isimler konuşuluyor","Basın toplantısında tansiyon yükseldi","Başkan locasında acil toplantı var","Taraftar grupları koreografi hazırlıyor","Rakip hoca kadroyu saklıyor","Son dakika sponsor görüşmesi başladı","Kasa açığı yönetimde gündem oldu","Transfer komitesi sabaha kadar çalıştı","Forvet piyasasında fiyatlar uçtu","Kaleci arayan kulüpler sıraya girdi","Kupa yayınında reyting rekoru bekleniyor","Şehirde final hayali konuşuluyor","Pazar raporu: risk kartları pahalı","Oyuncu temsilcileri tesis kapısında","Rakip kanatta zaaf iddiası","Başkan sabır istedi","Taraftar sabır değil zafer istiyor","Kulüp otobüsü tesislerden ayrıldı","Bir veteran liderlik konuşması yaptı","Genç yıldız antrenmanda parladı","Finans ekibi borç limitini uyardı","Tribünler biletleri tüketti","Kupa yolu yine kaosa gebe"],mgrDefault:"SEED",mgrPh:"",story:(mgr,team,chair,reached,motm,won,panic,wk,cid)=>{let p=`Transfer son gününde ${mgr} yönetiminde kurulan ${team}, `;p+=cid==="torpilci"?"başkanın torpilli yeğenlerine rağmen ":cid==="pinti"?"kısık bütçeye rağmen ":cid==="cilgin"?"kaos dolu bir yönetim altında ":cid==="babacan"?"başkanın açık çek desteğiyle ":cid==="leydi"?"dengeli bir yönetim desteğiyle ":cid==="sansasyoncu"?"şovmen bir başkanlık döneminde ":"";p+=`${reached} turuna kadar yükseldi. `;if(panic>0)p+=`Deadline paniğinde ${panic} oyuncu zorla kadroya katıldı. `;if(wk)p+=`Genç ${wk} turnuva boyunca patladı. `;p+=won?`Ve ${team} kupayı kaldırdı! ?? `:`Ama yolculuk burada bitti. `;p+=`Turnuvanın yıldızı: ${motm}.`;return p;},storyHdr:"SEZONUN HİKÂYESİ",chair:{babacan:{n:"Patron Başkan",role:"Büyük Patron",desc:"Kasa konusunda <b>cömert</b>, oyuncularına güvenen bir başkan. Finalde <b>eksi güç</b> bırakabilir ama <b>yolda yardımcıdır</b>.",hint:"?? Kasayı açık tutar · finalde küçük eksi güç"},leydi:{n:"Diplomat Başkan",role:"Adil El",desc:"<b>Adaletli</b> ve öngörülü; <b>yerli oyunculara</b> önem verir. <b>Kimyayı ödüllendirir</b>, gereksiz israftan kaçınır.",hint:"???? Yerli oyuncu sever · kimya primleri artar"},pinti:{n:"Pinti Başkan",role:"Demir Kasa",desc:"<b>Her kuruşu sayan</b>, borcu sevmeyen, <b>pazar indirimlerine</b> bayılan bir başkan. Sert bir <b>borç limiti</b> uygular.",hint:"Ucuz pazar · sert borç sınırı"},sansasyoncu:{n:"Şovmen Başkan",role:"Şov Zamanı",desc:"<b>Büyük isimler, büyük transferler.</b> Yıldız oyuncu peşinde koşar, <b>piyasayı ısıtır</b>. Basın toplantılarında şov yapar.",hint:"? Yıldız bonusu yüksek · pazar pahalı"},torpilci:{n:"Torpilci Başkan",role:"Yeğen Sezonu",desc:"<b>Yeğenlerini</b> ve çevresini kadroya sokmak için fırsat kollar. <b>Oyuncu kalitesi ikinci plandadır</b>.",hint:"????? Torpilli oyuncu dayatabilir"},cilgin:{n:"Profesör Başkan",role:"Joker",desc:"Kimse ne yapacağını bilemez. Toplantılar <b>öngörülemez</b>, kararlar <b>tutarsız</b>, müdahaleler <b>sürpriz dolu</b>.",hint:"?? Kuralsız müdahale eder · her şey mümkün"}},chem:{hdr:"KİMYA",young:"genç",tr:"yerli",vet:"tecrübe",none:"yok"},fan:{hdr:"TARAFTAR",s:["??","??","??","??"]},talkSub:"Bu maçlık moral etkisini seç:",talkUnder:"Rakip favori — ateşli ton işe yaradı.",talkFav:"Favorisin — odak ve disiplin şart.",talkDelta:"Güç",powHdr:"KADRO GÜCÜ",powHint:"detay ›",powHdr2:"GÜÇ DÖKÜMÜ",seedLbl:"SEED",presWord:"Başkan",cupTitle:"TÜRKİYE ULUSAL KUPASI FİNALİ",tcHdr:"TRANSFER CENTRE",assistLbl:"Asist:",stDraft:"Son gün, sıfırdan kuruldu",stChair:n=>n+" başkanlık etti",stPanic:n=>"Deadline paniğinde "+n+" zorunlu transfer",stWk:n=>"Genç "+n+" turnuvada patladı",stWon:t=>t+" Türkiye Ulusal Kupası'nı kaldırdı ??",stOut:r=>r+" turunda elendi",stMotm:n=>"Turnuvanın yıldızı: "+n,pbPlayers:"Oyuncular",pbCards:"Stil + Kart",pbChem:"Kimya",pbFan:"Taraftar",pbTotal:"TOPLAM",ctxHidden:"gizemli — risk al",ctxWonder:"geleceğin yıldızı ??",ctxStar:"takımın yıldızı",ctxBig:"büyük maç adamı",ctxLead:"soyunma odası lideri",ctxYoung:"genç yetenek",ctxLocal:"yerli gurur",ctxVet:"tecrübeli isim",ctxForm:"son maçlarda formda",ctxSolid:"güvenilir isim",talkOpt:{gaz:{i:"<svg viewBox='0 0 14 18' width='13' height='16' fill='none' stroke='currentColor' stroke-width='1.4' stroke-linecap='round' stroke-linejoin='round' class='si'><path d='M7 1Q4 5 4 9Q4 12 7 14Q10 12 10 9Q10 6 9 4Q9 8 7 10Q5 8 5 6Q5 3 7 1Z'><animate attributeName='stroke-width' values='1.4;2.2;1.4;1.8;1.4' dur='0.9s' repeatCount='indefinite'/></path><path d='M5 15Q3 18 7 18Q11 18 9 15'/></svg>",n:"Ateşle",d:"rakip favoriyse güçlü, sakatlık riski artırır"},mantik:{i:"<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='1.7' stroke-linecap='round' stroke-linejoin='round' class='si'><path d='M15.5 13a3.5 3.5 0 0 0 -3.5 3.5v1a3.5 3.5 0 0 0 7 0v-1.8'/><path d='M8.5 13a3.5 3.5 0 0 1 3.5 3.5v1a3.5 3.5 0 0 1 -7 0v-1.8'/><path d='M17.5 16a3.5 3.5 0 0 0 0 -7h-.5'/><path d='M19 9.3v-2.8a3.5 3.5 0 0 0 -7 0'/><path d='M6.5 16a3.5 3.5 0 0 1 0 -7h.5'/><path d='M5 9.3v-2.8a3.5 3.5 0 0 1 7 0v10'><animate attributeName='stroke-dasharray' values='0 30;30 0;30 0;0 30' dur='1.6s' repeatCount='indefinite'/></path></svg>",n:"Planı Hatırlat",d:"her durumda güvenli"},sert:{i:"<svg viewBox='0 0 14 16' width='12' height='14' fill='none' stroke='currentColor' stroke-width='1.5' stroke-linecap='round' class='si'><path d='M7 1L13 3.5V9Q13 13.5 7 15.5Q1 13.5 1 9V3.5Z'><animate attributeName='stroke-width' values='1.5;2.4;1.5' dur='1.2s' repeatCount='indefinite'/></path><polyline points='4.5,8 6.5,10 9.5,6'/></svg>",n:"Disiplin İste",d:"favoriyken iyi, genç kadroda riskli"}},
  ...
  primler_yatinca:{n:"Riziko",i:"??",d:"Ücretsiz. COMMON: +5 güç, gelecek tur −€6M. DARK: +9 güç, gelecek tur −€12M."},
  ...
  bu_adam:{n:"Joker",i:"?",d:"COMMON: 70-79 güçlü rastgele bir oyuncuyu yedeğe ekler. DARK: 80-89 güçlü rastgele bir oyuncuyu yedeğe ekler."},
  gec_gec:{n:"Barikat",i:"??",d:"Barikat eklenmeden önce rakibin GÜÇ değeri seninkinden yüksekse +5; yüksek değilse +2. DARK: +2 ek güç, finalde -3."},
  ...
  nasip_kismet:{n:"Piyango",i:"?",d:"COMMON: Satın alınca kupon açılır; önündeki 2 turda aldığın ilk kart en fazla €5M ucuzlar (min. €2M). DARK: İndirim en fazla €8M olur; satın alırken %20 ihtimalle hemen €3M masraf çıkar."},
  ...
  pp:{generous:i=>["Beklenmedik Gelir","??",`kasaya €${i.delta}M`,`+€${i.delta}M`,1],sponsor:i=>["Yeni Sponsor","??","sponsor geliri geldi; yoğun program takımı bu maç yoracak",`+€${i.delta}M · bu maç -2 güç`,1],sale:i=>["Takımın adası satıldı","??","kulübün adası satıldı, gelir kasaya aktı",`+€${i.delta}M`,1],star:i=>["Yıldız Transferi","?",`başkan bağladı: ${i.name} (${i.ov})`,`${i.pos} +`,1],bargain:i=>["Anadolu Kelepiri","??",`taşradan cevher: ${i.name} (${i.ov})`,`-€${i.fee}M`,1],academy:i=>["Altyapı Patlaması","??",`tesisten: ${i.name} (${i.ov})`,`${i.pos} +`,1],youth:i=>["Genç Yetenek Keşfi","",`ücretsiz yedek: ${i.name} (${i.ov})`,`${i.pos} · ${i.ov}`,1],nephew:i=>["Torpilli Yeğen","??",`başkanın yeğeni: ${i.name} (${i.ov})`,`${i.pos} -`,0],cut:i=>["Kemer Sıkma","??","kısıntıya gidildi",`-€${i.delta}M`,0],yacht:i=>["Başkan Tekne Aldı","???","parayla yat alındı",`-€${i.delta}M`,0],tax:i=>["Vergi Cezası","??","devlet kapıyı çaldı",`-€${i.delta}M`,0],federation:i=>["Federasyon Yaptırımı","",i.mode==="fine"?"kural ihlali kasaya yansıdı":"takım bu maça güç cezasıyla çıkacak",i.mode==="fine"?`-€${i.delta}M`:"Bu maç -1 güç",0],ffp:i=>["FFP İncelemesi","","harcama planı nedeniyle transfer pazarı kapatıldı","Sonraki pazar kapalı",0],fans:i=>["Taraftar Protestosu","","tribün baskısı yönetimi ve takımı sarstı","Güven -1 · bu maç -2 güç",0],investigation:i=>["Şike Soruşturması","",`${i.risk} riskli kart incelemeye alındı`,`-€${i.delta}M · güven -1`,0],management:i=>["Yönetim Değişikliği","",`${i.old} görevden ayrıldı`,i.name?`Yeni başkan: ${i.name}`:"Yönetim değişti",0]}},
 en:{tagline:"",budget:"Funds",coverTitle:"Copa Life",coverSub:"Türkiye National Cup",
  coverBlurb:"Draft your XI. Finish top two across three group matches, then chase the cup through the knockout rounds.",
  ...
  startBtn:"START",cNamePh:"Name your club...",
  ...
  rounds:["GROUP · MATCH 1","GROUP · MATCH 2","GROUP · MATCH 3","ROUND OF 16","QUARTER FINAL","SEMI FINAL","FINAL"],rabbr:["G1","G2","G3","R16","QF","SF","F"],
 ...
 chLbl:"Challenges",chUnlock:"Card unlocked:",objHdr:"?? OBJECTIVES",feedHdr:"FEED",feedEmpty:"no news yet...",feedBuy:"signed",feedUnlock:"unlocked",chairHdr:"CHAIRMAN",hiddenName:"Mystery Player",hiddenMeta:"??? · gem or dud",cevher:"?? Gem!",balon:"?? Dud:",reveal:"revealed:",trait:{hizli:"Pacey",lider:"Leader",buyukmac:"Big Game",sorunlu:"Difficult",temasli:"Contact Play",wonderkid:"Wonderkid"},panicHead:"PANIC BUY!",panicFeed:"deadline hit, forced signing",panicMsg:(n,o,p)=>`Manager could not find a ${p}. A Power ${o} ${n} was forced in.`,heads:["Galatasaray hunting a new CB","Chairman questions the budget","Fans demand a striker","Osimhen rumours rumble on","Manager working the market","New star signing excites fans","Rival manager resigns"],mgrDefault:"SEED",mgrPh:"",story:(mgr,team,chair,reached,motm,won,panic,wk,cid)=>{let p=`Built from scratch on deadline day, ${team} `;p+=cid==="torpilci"?"survived boardroom favouritism and ":cid==="pinti"?"worked around a tight budget and ":cid==="cilgin"?"endured chaotic ownership and ":cid==="babacan"?"benefited from generous backing and ":cid==="leydi"?"thrived under balanced leadership and ":cid==="sansasyoncu"?"navigated a headline-hungry chairman and ":"";p+=`reached the ${reached}. `;if(panic>0)p+=`Deadline panic forced ${panic} emergency signing(s). `;if(wk)p+=`Young ${wk} broke out during the tournament. `;p+=won?`${team} lifted the cup. `:`The run ended there. `;p+=`Player of the tournament: ${motm}.`;return p;},storyHdr:"SEASON STORY",chair:{babacan:{n:"The Patron",role:"Big Patron",desc:"<b>Generous</b> and trusting. Keeps the coffers open and backs his manager — but may add a <b>power penalty at the final</b>.",hint:"?? Generous with funds · small final power cost"},leydi:{n:"The Diplomat",role:"The Fair Hand",desc:"<b>Fair</b> and forward-thinking. Values <b>local players</b> and rewards <b>team chemistry</b>. Avoids wasteful spending.",hint:"???? Loves local players · boosts chemistry bonuses"},pinti:{n:"The Miser",role:"Iron Safe",desc:"<b>Counts every cent.</b> Hates debt, loves a <b>discount</b>. Enforces the <b>strictest debt limit</b> of any chairman.",hint:"Cheap market · harsh debt limit"},sansasyoncu:{n:"The Showman",role:"Showtime",desc:"<b>Big names, big transfers.</b> Chases <b>star players</b> and heats up the market. Always hunting the next headline.",hint:"? High star bonus · expensive market"},torpilci:{n:"The Fixer",role:"Family Business",desc:"Slots in <b>nephews and allies</b> at every opportunity. <b>Player quality comes second</b> to loyalty.",hint:"????? May force low-quality players"},cilgin:{n:"The Professor",role:"Wild Card",desc:"Nobody knows what comes next. Meetings are <b>unpredictable</b>, decisions <b>inconsistent</b>, interventions <b>always a surprise</b>.",hint:"?? Erratic interference · anything goes"}},chem:{hdr:"CHEMISTRY",young:"young",tr:"local",vet:"leader",none:"none"},fan:{hdr:"FANS",s:["Angry","Uneasy","Happy","Buzzing"]},talkSub:"Pick a one-match morale effect:",talkUnder:"They are favourites - the fire-up worked.",talkFav:"You are favourites - focus and discipline matter.",talkDelta:"Power",powHdr:"SQUAD POWER",powHint:"detail ->",powHdr2:"POWER BREAKDOWN",seedLbl:"SEED",presWord:"Chairman",cupTitle:"TÜRKİYE NATIONAL CUP FINAL",tcHdr:"TRANSFER CENTRE",assistLbl:"Assist:",stDraft:"Built from scratch on deadline day",stChair:n=>n+" was in charge",stPanic:n=>n+" forced panic signing(s)",stWk:n=>"Young "+n+" broke out",stWon:t=>t+" lifted the Cup",stOut:r=>"Knocked out in the "+r,stMotm:n=>"Player of the tournament: "+n,pbPlayers:"Players",pbCards:"Style + Cards",pbChem:"Chemistry",pbFan:"Fans",pbTotal:"TOTAL",ctxHidden:"mystery player - take the risk",ctxWonder:"future superstar",ctxStar:"team talisman",ctxBig:"big-game player",ctxLead:"dressing-room leader",ctxYoung:"young talent",ctxLocal:"local pride",ctxVet:"experienced head",ctxForm:"in red-hot form",ctxSolid:"reliable name",talkOpt:{gaz:{i:"<svg viewBox='0 0 14 18' width='13' height='16' fill='none' stroke='currentColor' stroke-width='1.4' stroke-linecap='round' stroke-linejoin='round' class='si'><path d='M7 1Q4 5 4 9Q4 12 7 14Q10 12 10 9Q10 6 9 4Q9 8 7 10Q5 8 5 6Q5 3 7 1Z'><animate attributeName='stroke-width' values='1.4;2.2;1.4;1.8;1.4' dur='0.9s' repeatCount='indefinite'/></path><path d='M5 15Q3 18 7 18Q11 18 9 15'/></svg>",n:"Fire Up",d:"strong as underdog, raises injury risk"},mantik:{i:"<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='1.7' stroke-linecap='round' stroke-linejoin='round' class='si'><path d='M15.5 13a3.5 3.5 0 0 0 -3.5 3.5v1a3.5 3.5 0 0 0 7 0v-1.8'/><path d='M8.5 13a3.5 3.5 0 0 1 3.5 3.5v1a3.5 3.5 0 0 1 -7 0v-1.8'/><path d='M17.5 16a3.5 3.5 0 0 0 0 -7h-.5'/><path d='M19 9.3v-2.8a3.5 3.5 0 0 0 -7 0'/><path d='M6.5 16a3.5 3.5 0 0 1 0 -7h.5'/><path d='M5 9.3v-2.8a3.5 3.5 0 0 1 7 0v10'><animate attributeName='stroke-dasharray' values='0 30;30 0;30 0;0 30' dur='1.6s' repeatCount='indefinite'/></path></svg>",n:"Remind Plan",d:"safe in every match"},sert:{i:"<svg viewBox='0 0 14 16' width='12' height='14' fill='none' stroke='currentColor' stroke-width='1.5' stroke-linecap='round' class='si'><path d='M7 1L13 3.5V9Q13 13.5 7 15.5Q1 13.5 1 9V3.5Z'><animate attributeName='stroke-width' values='1.5;2.4;1.5' dur='1.2s' repeatCount='indefinite'/></path><polyline points='4.5,8 6.5,10 9.5,6'/></svg>",n:"Demand Discipline",d:"good as favourite, risky with youth"}},
  ...
  primler_yatinca:{n:"Risk",i:"??",d:"Free. COMMON: +5 power, next round −€6M. DARK: +9 power, next round −€12M."},
  ...
  bu_adam:{n:"Joker",i:"?",d:"COMMON: adds a random Power 70-79 player to the bench. DARK: adds a random Power 80-89 player to the bench."},
  gec_gec:{n:"Barricade",i:"??",d:"Before Barricade is added, opponent POWER > your POWER gives +5; otherwise +2. DARK adds +2 and carries -3 in the final."},
  ...
  nasip_kismet:{n:"Lottery",i:"?",d:"COMMON: On purchase, gain a coupon; the first card bought within the next 2 rounds costs up to €5M less (min. €2M). DARK: The discount is up to €8M; 20% chance of an immediate €3M expense on purchase."},
  ...
  pp:{generous:i=>["Unexpected Income","??",`+€${i.delta}M to coffers`,`+€${i.delta}M`,1],sponsor:i=>["New Sponsor","??","sponsor income arrived; the packed schedule tires the team",`+€${i.delta}M · this match -2 power`,1],sale:i=>["The Team's Island Was Sold","??","the club's island was sold and the proceeds entered the budget",`+€${i.delta}M`,1],star:i=>["Star Signing","?",`landed: ${i.name} (${i.ov})`,`${i.pos} +`,1],bargain:i=>["Local Bargain","??",`gem: ${i.name} (${i.ov})`,`-€${i.fee}M`,1],academy:i=>["Academy Breakthrough","??",`from academy: ${i.name} (${i.ov})`,`${i.pos} +`,1],youth:i=>["Youth Breakthrough","",`free bench player: ${i.name} (${i.ov})`,`${i.pos} · ${i.ov}`,1],nephew:i=>["The Useless Nephew","??",`nephew joins: ${i.name} (${i.ov})`,`${i.pos} -`,0],cut:i=>["Belt Tightening","??","budget cut",`-€${i.delta}M`,0],yacht:i=>["Chairman Bought a Yacht","???","club funds went to a yacht",`-€${i.delta}M`,0],tax:i=>["Tax Penalty","??","the tax office came calling",`-€${i.delta}M`,0],federation:i=>["Federation Sanction","",i.mode==="fine"?"a rule breach hit the budget":"the team carries a match penalty",i.mode==="fine"?`-€${i.delta}M`:"This match -1 power",0],ffp:i=>["FFP Review","","spending controls closed the transfer market","Next market closed",0],fans:i=>["Supporter Protest","","fan pressure shook the board and squad","Trust -1 · this match -2 power",0],investigation:i=>["Integrity Investigation","",`${i.risk} risky card${i.risk===1?"":"s"} reviewed`,`-€${i.delta}M · trust -1`,0],management:i=>["Boardroom Change","",`${i.old} left the club`,i.name?`New chairman: ${i.name}`:"Board changed",0]}},
};
Object.assign(T.tr.chair.babacan,{desc:"Borç limitin −€28M olur. Kart fiyatlarına +€1M eklenir. Başkan danışmalarında takımını destekleyen sonuçlar daha sık çıkar.",hint:"Geniş borç limiti · destekleyici danışmalar"});
Object.assign(T.tr.chair.leydi,{desc:"Yerli oyuncular draftta daha sık çıkar. Takım kimyan +3 veya üzerindeyse ilgili maçta +1 güç ve +1 başkan güveni kazanırsın. Kimya 0'ın altındaysa ilgili maçta −1 güç ve −1 başkan güveni alırsın.",hint:"Yerli oyuncu önceliği · kimyaya bağlı maç etkisi"});
Object.assign(T.tr.chair.pinti,{desc:"Transfer fiyatlarına %10 indirim uygulanır. Tur sonunda kasan 0 veya üzerindeyse birikimine €2M eklenir. Finalden önce birikimini final gücüne veya kasana çevirirsin.",hint:"İndirimli transfer · €2M tur birikimi · final seçimi"});
Object.assign(T.tr.chair.sansasyoncu,{desc:"Gücü 85–89 olan transfer ilgili maçta +2 güç, 90 ve üzeri transfer +3 güç kazandırır. Bu bonus ilgili turda yalnızca bir kez verilir. 1. ve 4. maçtan önce seçtiğin medya oyuncusu o maç +2 ila +4 güç kazanır. Sakatlanırsa bir sonraki pazarda kart fiyatlarına +€3M eklenir.",hint:"İlgili maçta yıldız bonusu · medya oyuncusu · sakatlıkta +€3M"});
Object.assign(T.tr.chair.torpilci,{desc:"Kart fiyatlarına −€1M indirim uygulanır. Her tur bir yeğen kararı gelir. Yeğeni kabul edersen gücü tur başına en fazla +3 artar ve kasana €3M eklenir. Kabul edersen final gücünden 1 puan eksilir.",hint:"İndirimli kart · zorunlu yeğen kararı · final bedeli"});
Object.assign(T.tr.chair.cilgin,{desc:"Başkan kararları ve kart sonuçları rastgele değişebilir. Oyun boyunca en fazla iki kez kaos zarı atabilirsin. Başkan güvenin 0'dan büyükse zarı pas geçebilirsin. DARK kartlar pazarda görünebilir.",hint:"Rastgele kararlar · iki kaos zarı · DARK kartlar"});
Object.assign(T.en.chair.babacan,{desc:"Your debt limit is −€28M. Card prices increase by +€1M. Supportive consultation results appear more often.",hint:"Wide debt limit · supportive consultations"});
Object.assign(T.en.chair.leydi,{desc:"Local players appear more often in the draft. At +3 chemistry or higher, you gain +1 power and +1 chairman trust in that match. Below 0 chemistry, you lose −1 power and −1 chairman trust in that match.",hint:"Local player priority · chemistry match effect"});
Object.assign(T.en.chair.pinti,{desc:"Transfers receive a 10% discount. If your cash is 0 or higher at the end of a round, €2M is added to savings. Before the final, convert savings into final power or cash.",hint:"Discounted transfers · €2M round savings · final choice"});
Object.assign(T.en.chair.sansasyoncu,{desc:"A signing rated 85–89 gives +2 power in that match. A signing rated 90 or higher gives +3 power. This bonus is awarded only once per round. Before matches 1 and 4, your chosen media player gains +2 to +4 power in that match. If injured, the next market adds +€3M to card prices.",hint:"Matchday star bonus · media player · +€3M injury pressure"});
Object.assign(T.en.chair.torpilci,{desc:"Card prices receive a −€1M discount. One nephew decision appears each round. Accepting the nephew gives up to +3 power each round and adds €3M to cash. It also removes 1 point from final power.",hint:"Discounted cards · mandatory nephew · final cost"});
Object.assign(T.en.chair.cilgin,{desc:"Chairman decisions and card results can vary randomly. You can roll the chaos die at most twice per run. You can skip it while chairman trust is above 0. DARK cards can appear in the market.",hint:"Random decisions · two chaos rolls · DARK cards"});
...
function _patchCardCopy(){
 ...
 Object.assign(tr,{
  ...
  ch_momentum:{...tr.ch_momentum,d:"Turnuva ilerledikçe takımın kazandığı ritmi güce çevirir. COMMON: 1-2. tur +1, 3-4. tur +3, 5. turdan itibaren +5. DARK: +2/+5/+8; finalde -6 güç."},
  ...
  yildiz:{...tr.yildiz,n:"Lokomotif",d:"Tek kullanımlık. Gücü en yüksek oyuncuna göre güç verir. DARK daha güçlüdür ama %25 ihtimal -€6M ceza taşır."},
  ...
  mac_sozu:{...(tr.mac_sozu||{n:"Maç Sözü",i:""}),d:"Maçtan önce gol yememe sözü ver. COMMON: başarıda yalnız sonraki maç +3 güç. DARK: başarıda sonraki maç +5, başarısızlıkta -3. Aynı anda yalnızca bir söz aktif olabilir."},
  ...
  tecrubeli_omurga:{...(tr.tecrubeli_omurga||{n:"Duvar!",i:""}),n:"Duvar!",d:"Yalnız ilk 11'deki 32 yaş ve üzeri oyuncuları sayar. COMMON oyuncu başına +1 (max +4), DARK oyuncu başına +2 (max +6); DARK finalde -4 güç."},
  yerli_blok:{...tr.yerli_blok,d:"Build kartı. COMMON ilk 11'deki yerli başına +1 güç (max +5). DARK yerli başına +2 (max +8); finalde -3 güç."},
  kaptanin_karari:{...(tr.kaptanin_karari||{n:"Kaptanın Kararı",i:""}),d:"Olumsuz takım konuşmasından sonra tur başına bir kez kullanılır. COMMON: etkiyi sıfırlar; kaptan o maç -2 efektif güç. DARK: etkiyi sıfırlar, maçlık +1 kimya; kaptan -3 efektif güç."},
  ...
  final_provasi:{...(tr.final_provasi||tr.ch_final||{n:"Son Koz",i:""}),n:"Son Koz",d:"Yalnız final maçında çalışır. COMMON finalde +5 güç verir. DARK finalde +9 güç verir; satın alırken %25 ihtimalle €3M ek masraf çıkarır."},
  son_dans:{...tr.son_dans,d:"Yalnızca finalde çalışır. COMMON: İlk 11'de sakat yoksa +7, en az 1 sakat varsa +3. DARK: sakat yoksa +10, en az 1 sakat varsa +0."},
  ...
  kara_borsa:{...(tr.kara_borsa||{n:"Kara Borsa",i:""}),d:"COMMON: €3M; bir kart yak, tur havuzundan gösterilen 3 COMMON karttan 1'ini seç. DARK: €7M; 4 karttan 2'sini seç, %25 ihtimal -€8M ceza."},
  sahte_evrak:{...(tr.sahte_evrak||{n:"Mükâfat",i:""}),n:"Mükâfat",d:"Kontrat risk kartı. COMMON €6M: +5 güç/tur; edinirken %18 ihtimal güven -1. DARK €8M: +8 güç/tur, güven -1 ve finalde -8 güç."},
  ...
  doping:{n:"Doping Söylentisi",i:"ğŸ’‰",...tr.doping,d:"Kontrat risk kartı. COMMON €7M: +6 güç/tur; edinirken %20 güven -1, her tur %25 ihtimal -€10M ve en fazla 2 ceza. DARK €9M: +9 güç/tur, güven -1, her tur %20 ihtimal -€18M, en fazla 2 ceza ve finalde -8 güç."},
  kriz:{n:"Kriz Yönetimi",i:"⚠",...tr.kriz,d:"COMMON €9M: final cezasının %50'sini, en fazla 6 gücü telafi eder. DARK €12M: %65'ini, en fazla 10 gücü telafi eder; satın alırken %20 ihtimalle €5M ek danışmanlık masrafı."},
  primler_yatinca:{...tr.primler_yatinca,n:"Riziko",d:"Ücretsiz ertelenmiş ödeme. COMMON şimdi +5 güç / gelecek tur −€6M. DARK şimdi +9 güç / gelecek tur −€12M."},
  ...
  bu_adam:{...tr.bu_adam,n:"Joker",d:"Yedek hamlesi. COMMON 70-79 güçlü rastgele bir oyuncuyu yedeğe ekler. DARK 80-89 güçlü bir oyuncu ekler; %25 ihtimalle €6M imza masrafı çıkarır."},
  gec_gec:{...tr.gec_gec,n:"Barikat",d:"COMMON: Barikat eklenmeden önce rakibin GÜÇ değeri seninkinden yüksekse +5; yüksek değilse +2. DARK: +7/+4; her tur %25 sakatlık riski ve finalde -3 güç."},
  nasip_kismet:{...tr.nasip_kismet,n:"Piyango",d:"COMMON: Satın alınca kupon açılır; önündeki 2 turda aldığın ilk kart en fazla €5M ucuzlar (min. €2M). DARK: İndirim en fazla €8M olur; satın alırken %20 ihtimalle hemen €3M masraf çıkar."},
 ...
 Object.assign(en,{
  ...
  ch_momentum:{...en.ch_momentum,d:"Converts the team's growing tournament rhythm into power. COMMON: +1 in rounds 1-2, +3 in rounds 3-4, then +5. DARK: +2/+5/+8; -6 power in the final."},
  ...
  yildiz:{...en.yildiz,n:"Locomotive",d:"Single use. Power scales from your highest-power player. DARK is stronger but has 25% chance -€6M fine."},
  ...
  mac_sozu:{...(en.mac_sozu||{n:"Match Promise",i:""}),d:"Promise a clean sheet before the match. COMMON: success grants +3 only in the next match. DARK: success grants +5 next match; failure gives -3. Only one promise can be active."},
  ...
  tecrubeli_omurga:{...(en.tecrubeli_omurga||{n:"The Wall!",i:""}),n:"The Wall!",d:"Counts only age-32+ starters. COMMON adds +1 each (max +4). DARK adds +2 each (max +6) and -4 power in the final."},
  yerli_blok:{...en.yerli_blok,d:"Build card. COMMON adds +1 per local starter (max +5). DARK adds +2 each (max +8) and -3 power in the final."},
  kaptanin_karari:{...(en.kaptanin_karari||{n:"Captain's Call",i:""}),d:"Use once per run after a negative team talk. COMMON: neutralizes it; captain has -2 effective power that match. DARK: neutralizes it, adds +1 match chemistry; captain has -3 effective power."},
  ...
  final_provasi:{...(en.final_provasi||en.ch_final||{n:"Last Resort",i:""}),n:"Last Resort",d:"Works only in the final. COMMON adds +5 power. DARK adds +9 power and has a 25% chance of an extra €3M cost when acquired."},
  son_dans:{...en.son_dans,d:"Final only. COMMON: +7 with no injured starter, +3 with at least 1. DARK: +10 with none, +0 with at least 1 injured starter."},
  ...
  kara_borsa:{...(en.kara_borsa||{n:"Black Market",i:""}),d:"COMMON: €3M; burn one card and choose 1 of 3 COMMON cards from this round's pool. DARK: €7M; choose 2 of 4, with a 25% chance of an €8M fine."},
  sahte_evrak:{...(en.sahte_evrak||{n:"Reward",i:""}),n:"Reward",d:"Contract risk card. COMMON €6M: +5 power/round and 18% chance trust -1 on acquisition. DARK €8M: +8 power/round, trust -1 and -8 power in the final."},
  ...
  doping:{...en.doping,d:"Contract risk card. COMMON €7M: +6 power/round, 20% trust risk and a 25% chance of a €10M fine each round, max 2 fines. DARK €9M: +9, trust -1, 20% chance of an €18M fine each round, max 2 fines and -8 in the final."},
  kriz:{...en.kriz,d:"COMMON €9M offsets 50% of the final penalty, up to 6. DARK €12M offsets 65%, up to 10, with a 20% chance of an extra €5M consultancy cost on acquisition."},
  primler_yatinca:{...en.primler_yatinca,n:"Risk",d:"Free deferred payment. COMMON +5 power now / −€6M next round. DARK +9 power now / −€12M next round."},
  ...
  bu_adam:{...en.bu_adam,n:"Joker",d:"Bench move. COMMON adds a random Power 70-79 player. DARK adds an Power 80-89 player with a 25% chance of an extra €6M signing cost."},
  gec_gec:{...en.gec_gec,n:"Barricade",d:"COMMON: Before Barricade is added, if the opponent's POWER is higher than yours: +5; otherwise +2. DARK: +7/+4; 25% injury risk each round and -3 final power."},
  nasip_kismet:{...en.nasip_kismet,n:"Lottery",d:"COMMON: On purchase, gain a coupon; the first card bought within the next 2 rounds costs up to €5M less (min. €2M). DARK: The discount is up to €8M; 20% chance of an immediate €3M expense on purchase."},
...
function _patchVariantDescriptions(){
 const split={
  tr:{
   ...
   yerli_blok:"COMMON: Yerli başına +1, max +5. DARK: Başına +2, max +8; finalde -3.",
   ...
   son_dans:"COMMON: Finalde sakatsız +7, sakatlıkta +3. DARK: Sakatsız +10, sakatlıkta +0.",
   ...
   kara_borsa:"COMMON: €3M; bir kart yak, 3 COMMON karttan 1'ini seç. DARK: €7M; 4 karttan 2'sini seç, %25 ihtimal -€8M.",
   sahte_evrak:"COMMON: €6M; her tur +5, edinirken %18 güven -1. DARK: €8M; her tur +8, güven -1 ve finalde -8.",
   ...
   doping:"COMMON: €7M, +6/tur; %20 güven riski, her tur %25 ihtimal -€10M. DARK: €9M, +9/tur; güven -1, her tur %20 ihtimal -€18M, finalde -8. Tur boyunca en fazla 2 ceza.",
   kriz:"COMMON: €9M, final cezasının %50'sini max 6 telafi eder. DARK: €12M, %65'ini max 10 telafi eder; %20 ihtimalle €5M ek masraf.",
   primler_yatinca:"Ücretsiz. COMMON: Şimdi +5 güç, gelecek tur −€6M. DARK: Şimdi +9 güç, gelecek tur −€12M.",
   ...
   gec_gec:"COMMON: Barikat eklenmeden önce rakip GÜÇ > senin GÜÇ ise +5; aksi halde +2. DARK: +7/+4; her tur %25 sakatlık riski ve finalde -3 güç.",
   nasip_kismet:"COMMON: Satın alınca kupon açılır; önündeki 2 turda aldığın ilk kart en fazla €5M ucuzlar (min. €2M). DARK: İndirim en fazla €8M olur; satın alırken %20 ihtimalle hemen €3M masraf çıkar.",
  ...
  en:{
   ...
   yerli_blok:"COMMON: +1 per local starter, max +5. DARK: +2 each, max +8; -3 in the final.",
   ...
   son_dans:"COMMON: Healthy final squad +7, injured +3. DARK: Healthy +10, injured +0.",
   ...
   kara_borsa:"COMMON: €3M; burn one, choose 1 of 3 COMMON cards. DARK: €7M; choose 2 of 4, 25% chance of an €8M fine.",
   sahte_evrak:"COMMON: €6M; +5/round, 18% chance of trust -1 on acquisition. DARK: €8M; +8/round, trust -1 and -8 in the final.",
   ...
   doping:"COMMON: €7M, +6/round; 20% trust risk, 25% chance -€10M each round. DARK: €9M, +9/round, trust -1, 20% chance -€18M each round and -8 in the final. At most 2 fines per run.",
   kriz:"COMMON: €9M, offsets 50% of the final penalty up to 6. DARK: €12M, offsets 65% up to 10; 20% chance of an extra €5M cost.",
   primler_yatinca:"Free. COMMON: +5 power now, next round −€6M. DARK: +9 power now, next round −€12M.",
   ...
   gec_gec:"COMMON: Before Barricade, opponent POWER > your POWER gives +5; otherwise +2. DARK: +7/+4; 25% injury risk each round and -3 final power.",
   nasip_kismet:"COMMON: On purchase, gain a coupon; the first card bought within the next 2 rounds costs up to €5M less (min. €2M). DARK: The discount is up to €8M; 20% chance of an immediate €3M expense on purchase.",
...
function _patchVisibleCardCostCopy(){
 ...
 if(tr.kara_borsa)tr.kara_borsa.d="COMMON: €3M; bir kart yak, o turun uygun havuzundan gösterilen 3 COMMON karttan 1'ini seç. DARK: €7M; 4 karttan 2'sini seç, %25 ihtimal -€8M ceza.";
 if(en.kara_borsa)en.kara_borsa.d="COMMON: €3M; burn one card and choose 1 of 3 COMMON cards from that round's eligible pool. DARK: €7M; choose 2 of 4, with a 25% chance of an €8M fine.";
}
...
T.es=_createLocale(T.en,{
 ...
 budget:"Caja",coverTitle:"Copa Life",coverSub:"Copa Nacional de Turquía",
 ...
 startBtn:"EMPEZAR",cNamePh:"Nombre del club",
...
T.de=_createLocale(T.en,{
 ...
 budget:"Kasse",coverTitle:"Copa Life",coverSub:"Nationalpokal Türkei",
 ...
 startBtn:"STARTEN",cNamePh:"Vereinsname",
...
T.it=_createLocale(T.en,{
 ...
 budget:"Cassa",coverTitle:"Copa Life",coverSub:"Coppa Nazionale di Turchia",
 ...
 startBtn:"INIZIA",cNamePh:"Nome del club",
...
T.es=_createLocale(T.es,{
 ...
 rounds:["GRUPO · PARTIDO 1","GRUPO · PARTIDO 2","GRUPO · PARTIDO 3","OCTAVOS DE FINAL","CUARTOS DE FINAL","SEMIFINAL","FINAL"],rabbr:["G1","G2","G3","OF","CF","SF","F"],vsword:"te enfrentas a",
 ...
 trait:{hizli:"Veloz",lider:"Líder",buyukmac:"Partidos grandes",sorunlu:"Conflictivo",temasli:"Juego de contacto",wonderkid:"Joven promesa"},panicHead:"¡FICHAJE DE PÁNICO!",panicFeed:"se agotó el plazo: fichaje forzado",mgrDefault:"SEMILLA",metaLine:(b,r)=>`mejor: <b>${b}</b> · partidas: <b>${r}</b>`,storyHdr:"HISTORIA DE LA TEMPORADA",
 ...
 talkSub:"Elige un efecto de moral para este partido:",talkUnder:"Son favoritos: motivar al equipo funcionó.",talkFav:"Sois favoritos: importan la concentración y la disciplina.",talkDelta:"Potencia",powHdr:"POTENCIA DE LA PLANTILLA",powHint:"detalle →",powHdr2:"DESGLOSE DE POTENCIA",presWord:"Presidente",cupTitle:"FINAL DE COPA",tcHdr:"CENTRO DE FICHAJES",assistLbl:"Asistencia:",stDraft:"Creado desde cero el día del cierre",
...
T.de=_createLocale(T.de,{
 ...
 rounds:["GRUPPE · SPIEL 1","GRUPPE · SPIEL 2","GRUPPE · SPIEL 3","ACHTELFINALE","VIERTELFINALE","HALBFINALE","FINALE"],rabbr:["G1","G2","G3","AF","VF","HF","F"],vsword:"du triffst auf",
 ...
 trait:{hizli:"Schnell",lider:"Führungsspieler",buyukmac:"Große Spiele",sorunlu:"Schwierig",temasli:"Körperbetontes Spiel",wonderkid:"Wundertalent"},panicHead:"PANIKKAUF!",panicFeed:"Frist abgelaufen, Zwangstransfer",mgrDefault:"SEED",metaLine:(b,r)=>`Bestwert: <b>${b}</b> · Partien: <b>${r}</b>`,storyHdr:"SAISONGESCHICHTE",
...
T.it=_createLocale(T.it,{
 ...
 rounds:["GIRONE · PARTITA 1","GIRONE · PARTITA 2","GIRONE · PARTITA 3","OTTAVI DI FINALE","QUARTI DI FINALE","SEMIFINALE","FINALE"],rabbr:["G1","G2","G3","OF","QF","SF","F"],vsword:"affronti",
 ...
 trait:{hizli:"Veloce",lider:"Leader",buyukmac:"Grandi partite",sorunlu:"Difficile",temasli:"Gioco di contatto",wonderkid:"Talento"},panicHead:"ACQUISTO DI PANICO!",panicFeed:"tempo scaduto, acquisto forzato",mgrDefault:"SEED",metaLine:(b,r)=>`migliore: <b>${b}</b> · partite: <b>${r}</b>`,storyHdr:"STORIA DELLA STAGIONE",
 ...
 talkSub:"Scegli un effetto morale per questa partita:",talkUnder:"Sono favoriti: la carica ha funzionato.",talkFav:"Siete favoriti: contano concentrazione e disciplina.",talkDelta:"Forza",powHdr:"FORZA DELLA ROSA",powHint:"dettagli →",powHdr2:"DETTAGLIO FORZA",presWord:"Presidente",cupTitle:"FINALE DI COPPA",tcHdr:"CENTRO TRASFERIMENTI",assistLbl:"Assist:",stDraft:"Costruita da zero nell'ultimo giorno di mercato",
...
/* Turkish card keys and mechanics are canonical. Names are translated, while each
   description mirrors the same prices, power and delayed/final costs. */
Object.assign(T.es.cards,{
 sahte_evrak:{...T.es.cards.sahte_evrak,n:"Recompensa",d:"Carta de riesgo contractual. COMMON €6M: +5 de fuerza por ronda y 18% de probabilidad de confianza -1 al comprarla. DARK €8M: +8 por ronda, confianza -1 y -8 en la final."},
 primler_yatinca:{...T.es.cards.primler_yatinca,n:"Riesgo",d:"Gratis. COMMON: +5 de fuerza ahora y −€6M la próxima ronda. DARK: +9 ahora y −€12M la próxima ronda."},
 deplasman_kafilesi:{...T.es.cards.deplasman_kafilesi,n:"Los Devotos",d:"COMMON €4M: +6 contra un rival con más fuerza total que tu plantilla; si no, +2. DARK €6M: +9 contra uno más fuerte; si no, 50% +4 / 50% -2."},
 tecrubeli_omurga:{...T.es.cards.tecrubeli_omurga,n:"¡El Muro!"},
 yildiz:{...T.es.cards.yildiz,n:"Locomotora"},
 final_provasi:{...T.es.cards.final_provasi,n:"Último Recurso"},
 bu_adam:{...T.es.cards.bu_adam,n:"Comodín"},
 gec_gec:{...T.es.cards.gec_gec,n:"Barricada"}
});
Object.assign(T.de.cards,{
 sahte_evrak:{...T.de.cards.sahte_evrak,n:"Belohnung",d:"Vertrags-Risikokarte. COMMON €6M: +5 Stärke pro Runde und beim Kauf 18% Chance auf Vertrauen -1. DARK €8M: +8 pro Runde, Vertrauen -1 und -8 im Finale."},
 primler_yatinca:{...T.de.cards.primler_yatinca,n:"Risiko",d:"Kostenlos. COMMON: jetzt +5 Stärke und nächste Runde −€6M. DARK: jetzt +9 und nächste Runde −€12M."},
 deplasman_kafilesi:{...T.de.cards.deplasman_kafilesi,n:"Die Getreuen",d:"COMMON €4M: +6 gegen einen Gegner, der stärker als deine gesamte Kaderstärke ist; sonst +2. DARK €6M: +9 gegen einen stärkeren Gegner; sonst 50% +4 / 50% -2."},
 tecrubeli_omurga:{...T.de.cards.tecrubeli_omurga,n:"Die Mauer!"},
 yildiz:{...T.de.cards.yildiz,n:"Lokomotive"},
 final_provasi:{...T.de.cards.final_provasi,n:"Letzter Trumpf"},
 bu_adam:{...T.de.cards.bu_adam,n:"Joker"},
 gec_gec:{...T.de.cards.gec_gec,n:"Barrikade"}
});
Object.assign(T.it.cards,{
 sahte_evrak:{...T.it.cards.sahte_evrak,n:"Ricompensa",d:"Carta rischio contratto. COMMON €6M: +5 forza per turno e 18% di probabilità di fiducia -1 all'acquisto. DARK €8M: +8 per turno, fiducia -1 e -8 in finale."},
 primler_yatinca:{...T.it.cards.primler_yatinca,n:"Rischio",d:"Gratis. COMMON: +5 forza ora e −€6M nel prossimo turno. DARK: +9 ora e −€12M nel prossimo turno."},
 deplasman_kafilesi:{...T.it.cards.deplasman_kafilesi,n:"I Fedeli",d:"COMMON €4M: +6 contro un avversario più forte della tua potenza totale; altrimenti +2. DARK €6M: +9 contro un avversario più forte; altrimenti 50% +4 / 50% -2."},
 tecrubeli_omurga:{...T.it.cards.tecrubeli_omurga,n:"Il Muro!"},
 yildiz:{...T.it.cards.yildiz,n:"Locomotiva"},
 final_provasi:{...T.it.cards.final_provasi,n:"Ultima Risorsa"},
 bu_adam:{...T.it.cards.bu_adam,n:"Jolly"},
 gec_gec:{...T.it.cards.gec_gec,n:"Barricata"}
});
...
Object.values(T).forEach(function(locale){
 ...
 locale.proto=_copaLifeBrand(locale.proto);
 locale.again=_copaLifeBrand(locale.again);
 if(locale.ui)locale.ui.postBand=_copaLifeBrand(locale.ui.postBand);
});
...
var COPA_LOCALE_UI={
 ...
 en:{label:"LANGUAGE",a11y:"ACCESSIBILITY",sound:"SOUND & MUSIC",guide:"COPA GUIDE",anim:"REDUCE MOTION",audio:"SOUND",music:"MUSIC",advanced:"ADVANCED SETTINGS",country:"PICK YOUR COUNTRY",title:"Copa Life — Roguelite football squad management game",contact:"CONTACT",settings:"Settings",reduceMotion:"Reduce motion",soundEffects:"Sound effects",heroTitle:"Roll the dice. Build your squad.<br><span class=\"v7-tagline-accent\">Defy fate.</span>",heroDesc:"Write a new football story with every choice.",newLabel:"NEW",contactPrompt:"Question, idea, bug? · ",activeEffects:"ACTIVE EFFECTS",noEvents:"No events yet"},
 es:{label:"IDIOMA",a11y:"ACCESIBILIDAD",sound:"SONIDO Y MÚSICA",guide:"GUÍA COPA",anim:"REDUCIR ANIMACIONES",audio:"SONIDO",music:"MÚSICA",advanced:"AJUSTES AVANZADOS",country:"ELIGE TU PAÍS",title:"Copa Life — Gestión de plantilla de fútbol roguelite",contact:"CONTACTO",settings:"Ajustes",reduceMotion:"Reducir animaciones",soundEffects:"Efectos de sonido",heroTitle:"Lanza el dado. Forma tu equipo.<br><span class=\"v7-tagline-accent\">Desafía al destino.</span>",heroDesc:"Escribe una nueva historia de fútbol con cada decisión.",newLabel:"NUEVO",contactPrompt:"¿Pregunta, idea o error? · ",activeEffects:"EFECTOS ACTIVOS",noEvents:"Aún no hay eventos"},
 de:{label:"SPRACHE",a11y:"BARRIEREFREIHEIT",sound:"SOUND UND MUSIK",guide:"COPA-GUIDE",anim:"ANIMATIONEN REDUZIEREN",audio:"SOUND",music:"MUSIK",advanced:"ERWEITERTE EINSTELLUNGEN",country:"LAND AUSWÄHLEN",title:"Copa Life — Roguelite-Fußball-Kaderverwaltung",contact:"KONTAKT",settings:"Einstellungen",reduceMotion:"Animationen reduzieren",soundEffects:"Soundeffekte",heroTitle:"Würfle. Baue deinen Kader.<br><span class=\"v7-tagline-accent\">Fordere das Schicksal heraus.</span>",heroDesc:"Schreibe mit jeder Entscheidung eine neue Fußballgeschichte.",newLabel:"NEU",contactPrompt:"Frage, Idee oder Fehler? · ",activeEffects:"AKTIVE EFFEKTE",noEvents:"Noch keine Ereignisse"},
 it:{label:"LINGUA",a11y:"ACCESSIBILITÀ",sound:"AUDIO E MUSICA",guide:"GUIDA COPA",anim:"RIDUCI ANIMAZIONI",audio:"AUDIO",music:"MUSICA",advanced:"IMPOSTAZIONI AVANZATE",country:"SCEGLI IL PAESE",title:"Copa Life — Gestione rosa calcio roguelite",contact:"CONTATTI",settings:"Impostazioni",reduceMotion:"Riduci animazioni",soundEffects:"Effetti sonori",heroTitle:"Lancia il dado. Crea la rosa.<br><span class=\"v7-tagline-accent\">Sfida il destino.</span>",heroDesc:"Scrivi una nuova storia di calcio con ogni scelta.",newLabel:"NUOVO",contactPrompt:"Domanda, idea o errore? · ",activeEffects:"EFFETTI ATTIVI",noEvents:"Nessun evento"}
};
Object.values(COPA_LOCALE_UI).forEach(function(locale){locale.title=_copaLifeBrand(locale.title);});
...
function _applyCopaHeroTimeline(copy){
 var steps={
  ...
  es:[["Formación y presidente","Elige tu formación y presidente."],["Lanza el dado","Mira y elige candidatos por posición."],["Crea la plantilla","Refuerza la plantilla con cartas."],["Llega a la final","Traza un plan; no dependas de la suerte."]],
 ...
 document.querySelectorAll("#mechSection .mstep").forEach(function(step,index){
  ...
  if(text&&item){
   text.replaceChildren(document.createTextNode(item[0]));
   var detail=document.createElement("small");detail.textContent=item[1];text.appendChild(detail);
  }
 });
}
...
function _applyCopaLocaleUi(){
 ...
 var tagline=document.querySelector(".v7-tagline");if(tagline){if(typeof window.setCopaHeroTitle==="function")window.setCopaHeroTitle(copy.heroTitle);else tagline.innerHTML=copy.heroTitle;}
