...
var T={
 tr:{tagline:"",budget:"Kasa",coverTitle:"Copa Life",coverSub:"Türkiye Ulusal Kupası",
  ...
  rounds:["GRUP · 1. MAÇ","GRUP · 2. MAÇ","GRUP · 3. MAÇ","ÇEYREK FİNAL","YARI FİNAL","FİNAL"],rabbr:["G1","G2","G3","ÇF","YF","F"],
 ...
 en:{tagline:"",budget:"Funds",coverTitle:"Copa Life",coverSub:"Türkiye National Cup",
  ...
  rounds:["GROUP · MATCH 1","GROUP · MATCH 2","GROUP · MATCH 3","QUARTER FINAL","SEMI FINAL","FINAL"],rabbr:["G1","G2","G3","QF","SF","F"],
...
function _patchCardCopy(){
 ...
 Object.assign(tr,{
  ...
  kaptanin_karari:{...(tr.kaptanin_karari||{n:"Kaptanın Kararı",i:""}),d:"Olumsuz takım konuşmasından sonra run başına bir kez kullanılır. COMMON: etkiyi sıfırlar; kaptan o maç -2 efektif güç. DARK: etkiyi sıfırlar, maçlık +1 kimya; kaptan -3 efektif güç."},
...
function _patchVariantDescriptions(){
 const split={
  tr:{
   ...
   doping:"COMMON: €7M, +6/tur; %20 güven riski, her tur %25 ihtimal -€10M. DARK: €9M, +9/tur; güven -1, her tur %20 ihtimal -€18M, finalde -8. Run boyunca en fazla 2 ceza.",
...
T.es=_createLocale(T.es,{
 ...
 rounds:["GRUPO · PARTIDO 1","GRUPO · PARTIDO 2","GRUPO · PARTIDO 3","CUARTOS DE FINAL","SEMIFINAL","FINAL"],rabbr:["G1","G2","G3","CF","SF","F"],vsword:"te enfrentas a",
...
T.de=_createLocale(T.de,{
 ...
 rounds:["GRUPPE · SPIEL 1","GRUPPE · SPIEL 2","GRUPPE · SPIEL 3","VIERTELFINALE","HALBFINALE","FINALE"],rabbr:["G1","G2","G3","VF","HF","F"],vsword:"du triffst auf",
...
T.it=_createLocale(T.it,{
 ...
 rounds:["GIRONE · PARTITA 1","GIRONE · PARTITA 2","GIRONE · PARTITA 3","QUARTI DI FINALE","SEMIFINALE","FINALE"],rabbr:["G1","G2","G3","QF","SF","F"],vsword:"affronti",
