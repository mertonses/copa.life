...
var T={
 tr:{tagline:"",budget:"Kasa",coverTitle:"Copa Life",coverSub:"Türkiye Ulusal Kupası",
  coverBlurb:"11'ini draftla. transfer saati işliyor. üç grup maçında ilk ikiyi hedefle; ardından eleme yolunda kupaya yürü.",
 ...
 en:{tagline:"",budget:"Funds",coverTitle:"Copa Life",coverSub:"Türkiye National Cup",
  coverBlurb:"Draft your XI before the deadline. Finish top two across three group matches, then chase the cup through the knockout rounds.",
...
Object.assign(T.tr.chair.leydi,{desc:"<b>Yerli adaylara</b> öncelik veren dengeli bir başkan. Toplam kimya <b>+3 veya üstündeyse +1 güç</b>, negatifse <b>-1 güç</b> uygular.",hint:"Yerli draft önceliği · kimyaya göre ±1 güç"});
Object.assign(T.tr.chair.pinti,{desc:"Transferlerde indirim sağlar; <b>premium kartları ek fiyatla</b> sunar. Pozitif kasayla biten turlarda biriken para finalde <b>güce veya kasaya</b> çevrilir.",hint:"İndirimli transfer · premium kart ek fiyatı · birikim"});
Object.assign(T.tr.chair.cilgin,{desc:"Kararları <b>öngörülemez</b> ve kaos doludur. Olumlu ya da olumsuz sürprizler yaratır ve <b>DARK kartları çağırır</b>.",hint:"Kaos müdahaleleri · DARK kartları çağırır"});
Object.assign(T.en.chair.leydi,{desc:"A balanced chairman who prioritises <b>local draft candidates</b>. Grants <b>+1 power</b> at +3 total chemistry or better, and <b>-1</b> below zero.",hint:"Local draft priority · ±1 power from chemistry"});
Object.assign(T.en.chair.pinti,{desc:"Discounts transfers but offers <b>premium cards with a surcharge</b>. Savings earned after solvent rounds convert into <b>final power or cash</b>.",hint:"Discounted transfers · premium surcharge · savings"});
Object.assign(T.en.chair.cilgin,{desc:"His decisions are <b>unpredictable</b> and chaotic, bringing both upside and danger. He also <b>draws DARK cards</b> into the market.",hint:"Chaos interventions · draws DARK cards"});
