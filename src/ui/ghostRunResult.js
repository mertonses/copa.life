(function(global){
  ...
  const COPY={
    tr:{
      ...
      message:"Bu tur artık Hayalet Kulüp havuzunda.<br><strong>Kadro seçimlerin, dizilişin ve oyun tarzın başka oyuncuların karşısına çıkabilir.</strong>",
      support:"Tur sona erdi. Kulübün ise yaşamaya devam ediyor.",
      status:"HAVUZDA",
      club:"KULÜP",
      ...
      seed:"SEED",
      restart:"YENİ TUR BAŞLAT",
      copySeed:"SEED’İ KOPYALA",
      copied:"SEED KOPYALANDI",
      share:"PAYLAŞ",
      enable:"İZİN VER VE HAVUZA EKLE",
      pendingTitle:"TUR YAŞAMAYA DEVAM EDEBİLİR",
      pendingMessage:"Bu tur henüz Hayalet Kulüp havuzunda değil.<br><strong>Açık izin verirsen kadro seçimlerin, dizilişin ve oyun tarzın başka oyuncuların karşısına çıkabilir.</strong>",
