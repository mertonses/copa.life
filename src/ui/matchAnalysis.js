...
const COPY={
  tr:{title:"MAÇ ANALİZİ",subtitle:"Sonucu açıklayan üç kısa neden",expectation:"BEKLENTİ",turning:"KIRILMA NOKTASI",decision:"KARAR ETKİSİ",open:"MAÇI ANALİZ ET",close:"Analizi kapat",score:"Maç sonucu",
    ...
    fav:n=>`Maça +${n} güç avantajıyla başladın. Fark küçük olduğu için maçın sonucu açıktı.`,
    dogStrong:n=>`Rakip kağıt üzerinde +${n} güç öndeydi. Puan ya da galibiyet için pozisyonları çok daha iyi değerlendirmen gerekiyordu.`,
    dog:n=>`Rakip +${n} güç avantajlıydı, ancak fark maçı tek başına belirleyecek düzeyde değildi.`,
    even:"Takımların gücü birbirine yakındı. Sonucu ceza sahasındaki kritik anlar belirledi.",
    finishing:"Pozisyona girdin ama son vuruşlarda aynı başarıyı gösteremedin. Bitiricilik sonucu aşağı çekti.",
    clinical:"Rakip daha az pozisyondan daha fazla gol buldu. Bitiricilik maçın kırılma noktasıydı.",
    keeper:n=>`Rakip kaleci ${n} kurtarışla üstünlüğün büyümesini engelledi.`,
    shotVolume:n=>`Rakibinden ${n} şut fazla attın. Oyunu daha çok rakip yarı sahaya yıktın.`,
    cards:"Kartlar maçın dengesini ve sonraki hamle alanını etkiledi.",
    scoreSwing:"Oyun ve skor dengeliydi. Tek bir kritik pozisyon maçın yönünü değiştirdi.",
    ...
    tactics:n=>`${n} maç içi komut kullandın. Her komut yalnızca uygulandığı bölümde oyuna etki etti.`,
    neutralDecision:"Maç içi kararların etkisi sınırlı kaldı. Sonucu daha çok güç dengesi ve üretilen pozisyonların kalitesi belirledi."},
