(function(root){
  ...
  COPY.tr.arenaDesc="Canlı maçlar, sıralamada yükselme ve rövanş heyecanı.";
  COPY.en.arenaDesc="Live matches, a climb up the table and rematch drama.";
