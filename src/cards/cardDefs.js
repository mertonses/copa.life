...
kanat_akini:{price:6,kind:"power",mode:"scaling",
 ...
 son_dans:{price:6,kind:"final",mode:"scaling",
   eff:(s,r)=>{if(r<6)return 0;const v=variantOf("son_dans");const healthy=!(s||[]).some(p=>p&&p.injured);return v===1?(healthy?14:-8):(healthy?8:2);}},
 /* EKONOMİ */
 ...
 kriz:{price:11,kind:"final",mode:"instant",eff:(s,r)=>0},
