...
function cardEff(k,s,r){
 ...
 const noTierPower=[
  "taraftar","genc","ch_momentum","otobus","yildiz","derbi","ch_final","son_dans","kaleci_kalesi","buyuk_mac",
  "temiz_sayfa","kisa_kamp","taksit_transfer","kara_borsa","sahte_evrak","son_kredi",
  "altyapi_plani","tecrubeli_omurga","yerli_blok","kanat_akini","deplasman_kafilesi","sosyal_medya",
  "final_provasi","kupaci_kadro","sogukkanli_penaltici",
  "kumarbaz","gecici_prim","doping","kriz","cilgin_basin"
 ];
 ...
 if(k==="cift_forvet")return base+(t>=1&&s.filter(p=>p.pos==="ST").length>=2?1:0);
 return base+t;
}
