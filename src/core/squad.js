...
function valueOf(ov){const v=0.25*Math.exp(0.15*(ov-60));if(v<1)return Math.max(0.3,Math.round(v*10)/10);if(v<20)return Math.round(v*10)/10;return Math.round(v);}
