...
function mkOpt(name,ov,nat,pos,fab,club,age,tr){const pr=valueOf(ov);let price=(!fab&&typeof deadlineH!=="undefined"&&deadlineH<=6)?Math.max(1,Math.round(pr*1.15)):pr;if(!fab&&typeof chairmanTransferMultiplier==="function")price=Math.max(0.3,Math.round(price*chairmanTransferMultiplier()*10)/10);const o={name,ov,natG:nat,natPos:pos,pos,club:club||"",age:age||26,tr:tr||0,price,fab:!!fab,train:0,dev:0,trait:null,eff:ov};if(!fab&&typeof playerProfileKey==="function")Object.defineProperty(o,"profileKey",{value:playerProfileKey(typeof selectedCountry==="string"?selectedCountry:"TR",name,o.club,o.age),enumerable:false});assignTrait(o);return o;}
